...
var version = "1.1";
// 1.1 - 2022/10/20 - Now works with all languages by using path to the "shorts" logo.
...
function hideShorts() {
  ...
  var miniGuideEntries = document.querySelectorAll(
  ...
  richSections.forEach(function (richSection) {
    ...
    if (title.textContent == "Shorts" && richSection.style.display != "none") {
      richSection.style.display = "none";
      hiddenObj++;
    }

    var path = richSection.querySelector("path");
    if (
      path.getAttribute("d") ==
  ...
  guideEntries.forEach(function (guideEntry) {
    var path = guideEntry.querySelector("path");
  ...
  miniGuideEntries.forEach(function (miniGuideEntry) {
    var path = miniGuideEntry.querySelector("path");
